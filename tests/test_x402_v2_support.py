...
from multiclaw.services.eip3009 import parse_x402, create_payment
from multiclaw.services.signing import (
...
# The real Megalith v2 payment_required (base64), from the handoff / api.megalithlabs.ai
MEGALITH_V2_B64 = (
    "eyJ4NDAyVmVyc2lvbiI6MiwiZXJyb3IiOiJQYXltZW50IHJlcXVpcmVkIiwicmVzb3VyY2UiOns"
    "idXJsIjoiaHR0cDovL2FwaS5tZWdhbGl0aGxhYnMuYWkvYXNzZXRzL29ydGhvL29ydGhvLXIzLW"
    "M0LnRpZiIsImRlc2NyaXB0aW9uIjoiIiwibWltZVR5cGUiOiIifSwiYWNjZXB0cyI6W3sic2NoZ"
    "W1lIjoiZXhhY3QiLCJuZXR3b3JrIjoiZWlwMTU1Ojg0NTMiLCJhbW91bnQiOiIxMDAwIiwiYXNz"
    "ZXQiOiIweDgzMzU4OWZDRDZlRGI2RTA4ZjRjN0MzMkQ0ZjcxYjU0YmRBMDI5MTMiLCJwYXlUbyI"
    "6IjB4NjVCQzU1NTVhMjVlMjQ1NjlFNjlCQjBBZjNmNTFjNEVCZEE0MmU2ZCIsIm1heFRpbWVvdX"
    "RTZWNvbmRzIjo2MCwiZXh0cmEiOnsibmFtZSI6IlVTRCBDb2luIiwidmVyc2lvbiI6IjIifX1df"
    "Q=="
)
...
class TestParseDialects:
    ...
    def test_v1_payload_parses(self):
        ...
        assert req.max_amount_required == "1000"
        assert req.network == "eip155:8453"  # normalized from "base"
        assert req.resource == "http://api.megalithlabs.ai/assets/ortho/ortho-r3-c4.tif"
...
class TestParseRejections:
    ...
    def test_neither_amount_field_rejected(self):
        data = {"x402Version": 2, "accepts": [{
            "network": "eip155:8453", "payTo": "0x" + "ab" * 20, "asset": "0x" + "cd" * 20,
        }]}
    ...
    def test_ambiguous_both_amounts_no_version_rejected(self):
        data = {"accepts": [{
            "network": "eip155:8453", "maxAmountRequired": "1000", "amount": "1000",
...
class TestOutboundPayloadShape:
    ...
    def test_v1_conversion_is_flat(self):
        from multiclaw.services.signing import SigningService
        p = self._v2_payment()
        ...
        assert v1["network"] == "base"        # v1 network name
