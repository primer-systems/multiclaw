...
This runs on localhost only (port 9403 by default).
"""
...
class AdminRequestHandler(BaseHTTPRequestHandler):
    ...
    # Reference to the MultiClaw core (set by AdminAPIServer)
    core: "MultiClaw" = None
    ...
    def _transaction_to_dict(self, tx) -> dict:
        ...
        return {
            ...
            "resource": resource,
            # Computed field for backwards compatibility - prefer request_url over resource
            "resource_url": request_url or resource,
...
class AdminAPIServer:
    ...
    def __init__(self, core: "MultiClaw", port: int = 9403):
        self._core = core
        self._port = port
