...
Options:
  ...
  --password <pw>     Wallet password (or use MULTICLAW_PASSWORD env var)
  --yes               Skip confirmation prompt

Examples:
  address export A001 --wallet mywallet --password "secret" --yes
  MULTICLAW_PASSWORD="secret" address export A001 --wallet mywallet --yes
        ...
        if not self.core.is_wallet_unlocked():
            ...
            if wallet_name and password is not None:
                ...
                return CommandResult.fail(
                    ...
                    "Or set MULTICLAW_PASSWORD environment variable."
                )
