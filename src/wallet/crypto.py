...
# ============================================
# MultiClaw Wallet (Multi-Seed, Multi-Address)
# ============================================
...
class MultiClawWallet:
    ...
    Usage:
        ...
        # Load existing
        wallet = MultiClawWallet.load("primer.wallet", "password")
    """
    ...
    @classmethod
    def create(cls, password: str) -> "MultiClawWallet":
    ...
    @classmethod
    def load(cls, filepath: str | Path, password: str) -> "MultiClawWallet":
        """
        Load wallet from file.
